...
class TestDatabaseOperations:
    ...
    async def test_filter_by_arc_type(self, db_session):
        ...
        # Filter
        results = await factory.episodes.get_by_arc_type(ArcType.CREDIT_BOOM_AND_BUST.value)
    ...
    async def test_cycle_crud(self, db_session):
        ...
        cycle = await factory.cycles.create(
            Cycle(
                name="Test Cycle",
    ...
    async def test_cycle_hierarchy(self, db_session):
        ...
        # Create parent
        parent = await factory.cycles.create(
            Cycle(
                name="Parent Cycle",
        ...
        # Create child
        child = await factory.cycles.create(
            Cycle(
                name="Child Cycle",
