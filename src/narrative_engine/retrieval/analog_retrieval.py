...
class AnalogRetrievalEngine:
    ...
    def _categorize_phase(self, phase: ArcPhase) -> str:
        ...
        middle_phases = [ArcPhase.RISING_ACTION, ArcPhase.EUPHORIA, ArcPhase.CLIMAX, ArcPhase.DISTRESS]
        late_phases = [ArcPhase.FALLING_ACTION, ArcPhase.PANIC, ArcPhase.RESOLUTION, ArcPhase.REVULSION]
